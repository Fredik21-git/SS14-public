...
{
    private static readonly EntProtoId ActionCultCommuneProto = "ActionCultCommune";
    private static readonly EntProtoId ActionCultConstructCreateWallProto = "ActionCultConstructCreateWall";
    ...
    private void OnConstructStartup(EntityUid uid, CultConstructComponent comp, ComponentStartup args)
    {
        ...
        _actions.AddAction(uid, ActionCultCommuneProto);
        ...
        switch (comp.Kind)
        {
            ...
            case CultConstructKind.Juggernaut:
                _actions.AddAction(uid, ActionCultConstructCreateWallProto);
                break;
        }
